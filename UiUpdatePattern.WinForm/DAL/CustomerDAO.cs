...
new Customer(25, "Yara Yenderson")
    ...
    public int Add(Customer customer) => throw new NotImplementedException();
    public bool Delete(Customer customer) => throw new NotImplementedException();
    public Customer Get(int id) => throw new NotImplementedException();
    public bool Update(Customer customer) => throw new NotImplementedException();
